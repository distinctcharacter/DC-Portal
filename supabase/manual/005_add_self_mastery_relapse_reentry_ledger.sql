-- Paste this entire file into the Supabase SQL Editor for the portal project.
-- It adds the Self-Mastery Blueprint Relapse & Re-Entry Ledger to the live resource catalog.
